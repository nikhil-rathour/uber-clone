    ...
    <div className="min-h-screen bg-white flex flex-col p-4 sm:p-6">
      ...
      <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
        ...
        <div className="space-y-6">
          ...
          <Link 
            to="/captain-login"
            className="w-full block bg-yellow-600 hover:bg-yellow-700 text-white font-medium py-3 sm:py-4 px-4 rounded-lg text-base sm:text-lg transition-all duration-200 active:bg-yellow-800 text-center"
          >
            Continue as Captain
          </Link>
        </div>
